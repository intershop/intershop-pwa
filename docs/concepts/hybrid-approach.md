...
For deployments via PWA Helm Chart (requires PWA Helm Chart 0.10.0 or later), the Hybrid Approach can be enabled and configured with the following configuration parameters:
