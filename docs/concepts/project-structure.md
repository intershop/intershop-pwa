...
Additionally, the custom ESLint rules `project-structure` and `ban-imports-file-pattern` should be activated to have a feedback when adding files to the project.
