...
In order to facilitate server-side rendering (SSR), the default deployment uses dockerized [_express.js_](https://expressjs.com/) servers running [Angular SSR](https://v20.angular.dev/guide/ssr), orchestrated by [PM2](https://pm2.keymetrics.io).
