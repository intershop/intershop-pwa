...
Official documentation for Angular SSR can be found at [Angular SSR Guide](https://v20.angular.dev/guide/ssr).
...
To use a custom `robots.txt`, place it as a file in the `dist` folder at runtime.
