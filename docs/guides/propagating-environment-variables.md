...
[angular-injectiontoken-provide]: https://v18.angular.dev/guide/di/dependency-injection-providers
...
2. An effect running in Angular SSR extracts these properties and puts them into the state management.
