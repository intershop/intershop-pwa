...
For the shipped defaults, the source-resolution and whole-replacement behavior, examples for overriding, extending, or removing headers, common third-party origins, and PCI DSS 4.0 hardening, see the dedicated [Security Headers and Content Security Policy (CSP)](security-headers.md) guide.
