...
| ish-date-range-picker-field | Datepicker with range                                                                        | `minDays`: Computes the minDate by adding the minimum allowed days to today. `maxDays`: Computes the maxDate by adding the maximum allowed days to today. `startDate`: Computes the start date.                                                                                   |
