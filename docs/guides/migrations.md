...
The Intershop PWA now serves an [_llms.txt_](https://llmstxt.org/) file, an LLM-friendly site index, as static content via the NGINX container (see [Guide - llms.txt](./llms-txt.md)).
