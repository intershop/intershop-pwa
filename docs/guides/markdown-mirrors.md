...
These mirrors are intended for machine consumers, such as search crawlers and LLMs.
...
Page chrome such as header, footer, navigation, scripts, forms, and other interactive or non-content/screen-reader-only UI elements are stripped.
