...
- `npm run check` should complete successfully on local development environments after a feature or bug fix or migration has finished.
  This check can be left to a CI pipeline as well, but the task should be configured in a way that meets the requirements of the project.

## Further References

- [How to do projects with Intershop PWA 1.0 and Themes](https://www.youtube.com/watch?v=qz-ONgd9qdY)
- [Performing a Migration](./migrations-how-to.md)
