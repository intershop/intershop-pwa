...
You can introduce dynamic behavior by using [factory providers](https://v19.angular.dev/guide/di/dependency-injection-providers) to generate `ConfigurationGroup` objects.
