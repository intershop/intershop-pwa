...
You can introduce dynamic behavior by using [factory providers](https://v20.angular.dev/guide/di/defining-dependency-providers) to generate `ConfigurationGroup` objects.
