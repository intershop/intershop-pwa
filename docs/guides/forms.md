...
- Form validation:
  ...
  - If the user presses the submit button, all form controls of the form are validated. In case of validation errors, the focus is set to the first invalid form field. In small forms the submit button will be disabled as long as there is any unhandled form error.

See also [Guide - Accessibility in UX: Patterns and Rationale](../guides/accessibility-ux-pattern.md#form-patterns).
