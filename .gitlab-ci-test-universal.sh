...
universalTest 2 "${PWA_BASE_URL}/category/Cameras-Camcorders.584" "router-outlet><ish-category-page-container>"
universalTest 3 "${PWA_BASE_URL}/login" "Forgot your password?"
universalTest 4 "${PWA_BASE_URL}/register" "Create Account"
universalTest 5 "${PWA_BASE_URL}/category/Cameras-Camcorders" "<h1>Cameras</h1>"
universalTest 6 "${PWA_BASE_URL}/category/Cameras-Camcorders" "<h3>Webcams</h3>"
universalTest 7 "${PWA_BASE_URL}/category/Cameras-Camcorders.584" "add-to-compare"
universalTest 8 "${PWA_BASE_URL}/home" "intershop-pwa-state"
universalTest 9 "${PWA_BASE_URL}/home" "&q;baseURL&q;:&q;$ICM_BASE_URL"
universalTest 10 "${PWA_BASE_URL}/home" "<ish-cms-carousel>"
