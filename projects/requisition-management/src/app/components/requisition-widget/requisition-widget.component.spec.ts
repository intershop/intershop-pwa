...
import { RequisitionWidgetComponent } from './requisition-widget.component';

describe('Requisition Widget Component', () => {
  let component: RequisitionWidgetComponent;
  let fixture: ComponentFixture<RequisitionWidgetComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [RequisitionWidgetComponent, TranslateModule.forRoot()],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RequisitionWidgetComponent);
