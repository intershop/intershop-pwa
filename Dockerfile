...
COPY tsconfig.app.json tsconfig.json ngsw-config.json angular.json eslint.config.mjs .postcssrc.json /workspace/
COPY eslint-rules /workspace/eslint-rules
COPY schematics /workspace/schematics
COPY templates/esbuild /workspace/templates/esbuild
