...
import { initializeObservablesInNgoninitRule } from './rules/initialize-observables-in-ngoninit';
...
const rules = {
  ...
  'initialize-observables-in-ngoninit': initializeObservablesInNgoninitRule,
