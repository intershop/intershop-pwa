...
function createContainer(options) {
    return host => {
        ...
        options = common_1.applyNameAndPath('container', host, options);
        options = common_1.determineArtifactName('container', host, options);
        // tslint:disable-next-line:no-string-literal
        options['artifactName'] += 'Component';
        options = common_1.generateSelector('container', host, options);
