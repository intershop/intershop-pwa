...
describe('override Schematic', () => {
  ...
  it('should be created', () => {
    expect(appTree.files.filter(x => ['.component.', '.service.'].some(t => x.includes(t)))).toMatchInlineSnapshot(`
      Array [
  ...
  it('should override html if specified', async () => {
  ...
  it('should override scss on components with css if specified', async () => {
  ...
  it('should override scss for components without it', async () => {
  ...
  it('should override ts if specified', async () => {
