...
export class ProductTileComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //   'maximumPrice': 380
    // };
    this.mockData.images[2].effectiveUrl = environment.needMock ? this.mockData.images[2].effectiveUrl : (environment.base_url + this.mockData.images[2].effectiveUrl);
    this.mockData.images[0].effectiveUrl = environment.needMock ? this.mockData.images[0].effectiveUrl : (environment.base_url + this.mockData.images[0].effectiveUrl);
