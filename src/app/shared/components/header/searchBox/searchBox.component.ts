...
const statesWithFlags = [
  { 'name': 'choclate', 'flag': '5/5c/Flag_of_Alabama.svg/45px-Flag_of_Alabama.svg.png' },
  { 'name': 'choclate ice cream', 'flag': 'e/e6/Flag_of_Alaska.svg/43px-Flag_of_Alaska.svg.png' },
  { 'name': 'choclate coffee', 'flag': '9/9d/Flag_of_Arizona.svg/45px-Flag_of_Arizona.svg.png' },
  { 'name': 'choclate choclate', 'flag': '9/9d/Flag_of_Arkansas.svg/45px-Flag_of_Arkansas.svg.png' },
  { 'name': 'cadbury choclate', 'flag': '0/01/Flag_of_California.svg/45px-Flag_of_California.svg.png' },
  { 'name': 'ice cream', 'flag': '4/46/Flag_of_Colorado.svg/45px-Flag_of_Colorado.svg.png' },
  { 'name': 'Choco chips', 'flag': '9/96/Flag_of_Connecticut.svg/39px-Flag_of_Connecticut.svg.png' },
