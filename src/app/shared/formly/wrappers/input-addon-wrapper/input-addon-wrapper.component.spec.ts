...
import { InputAddonWrapperComponent } from './input-addon-wrapper.component';

describe('Input Addon Wrapper Component', () => {
    ...
    await TestBed.configureTestingModule({
      imports: [
        FormlyModule.forRoot({
          ...
          wrappers: [{ name: 'form-field-addon', component: InputAddonWrapperComponent }],
        }),
  ...
  it('should be rendered after creation', () => {
    ...
    expect(element.querySelector('ish-input-addon-wrapper')).toBeTruthy();
  });
});
