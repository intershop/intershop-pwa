...
describe('Column Wrapper Component', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ColumnWrapperComponent, MockPipe(TranslatePipe)],
    }).compileComponents();
  });
  ...
  it('should be rendered after creation', () => {
    ...
    expect(element.querySelector('ish-column-wrapper')).toBeTruthy();
  });
});
