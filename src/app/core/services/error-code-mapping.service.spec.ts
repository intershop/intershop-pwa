...
describe('Error code mapping service', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [{ provide: TranslateService, useFactory: () => instance(translateService) }, ErrorCodeMappingService],
    });
  ...
  it(
    'should return mapped error message with parameter when it is supplied by translate service',
    inject([ErrorCodeMappingService], (errorCodeMappingService: ErrorCodeMappingService) => {
  ...
  it(
    'should return mapped error message when it is supplied by translate service',
    inject([ErrorCodeMappingService], (errorCodeMappingService: ErrorCodeMappingService) => {
