...
describe('Payment Service', () => {
  ...
  describe('PayPal experience context', () => {
    ...
    it("should get PayPal payment instrument data when 'getPayPalPaymentInstrumentData' is called", done => {
      ...
      paymentService.getPayPalPaymentInstrumentData(paypalInstrument).subscribe(result => {
    ...
    it("should return error message when 'getPayPalPaymentInstrumentData' receives 3DS decline", done => {
      when(apiServiceMock.get(anyString(), anything())).thenReturn(
        of({
          data: {
            orderId: 'PAYPAL_ORDER_123',
    ...
    it("should handle missing card data when 'getPayPalPaymentInstrumentData' is called", done => {
      when(apiServiceMock.get(anyString(), anything())).thenReturn(
        of({
          data: {
            orderId: 'PAYPAL_ORDER_123',
