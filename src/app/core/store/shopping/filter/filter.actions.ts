...
export const applyFilter = createAction('[Filter] Apply Filter', payload<{ searchParameter: Record<string, string[]> }>());

export const applyFilterSuccess = createAction(
  '[Filter API] Apply Filter Success',
  payload<{ availableFilter: FilterNavigation; searchParameter: Record<string, string[]> }>()
);
...
export const loadProductsForFilter = createAction(
  ...
  payload<{ id: ProductListingID; searchParameter: Record<string, string[]>; page?: number; sorting?: string }>()
);
