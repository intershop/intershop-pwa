...
export const productsReducer = createReducer(
  initialState,
  on(loadProductFail, loadProductVariationsFail, (state, action): ProductsState => ({
    ...state,
  ...
  on(loadProductVariationsSuccess, (state, action): ProductsState => ({
    ...state,
  ...
  on(loadProductPartsSuccess, (state, action): ProductsState => ({
    ...state,
    parts: { ...state.parts, [action.payload.sku]: action.payload.parts },
  })),
  on(loadProductLinksSuccess, (state, action): ProductsState => ({
    ...state,
    links: { ...state.links, [action.payload.sku]: action.payload.links },
  })),
  on(productSpecialUpdate, (state, action): ProductsState =>
