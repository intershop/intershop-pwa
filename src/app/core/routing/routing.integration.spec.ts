...
describe('Routing Integration', () => {
  ...
  describe('navigating to a product page', () => {
    ...
    it('should land at the product page for simple syntax with sku and categoryUniqueId only', async () => {
      await router.navigateByUrl('/sku12345-ctgCAT');

      expect(location.path()).toEqual('/sku12345-ctgCAT');
    ...
    it('should land at the product page for syntax with slug, sku and categoryUniqueId', async () => {
      await router.navigateByUrl('/fancy-category/fancy-product-sku12345-ctgCAT');

      expect(location.path()).toEqual('/fancy-category/fancy-product-sku12345-ctgCAT');
  ...
  describe('special case with tokens in URL', () => {
    it('should navigate to the correct product page when sku contains "sku"', async () => {
      await router.navigateByUrl('/acer/glaSkugel-skuglaskugel_1-ctgHome');

      expect(location.path()).toEqual('/acer/glaSkugel-skuglaskugel_1-ctgHome');
    ...
    it('should navigate to the correct product page when category contains "cat"', async () => {
      await router.navigateByUrl('/furniture/cat-tree-skutree_1-ctgtrees-for-cats');

      expect(location.path()).toEqual('/furniture/cat-tree-skutree_1-ctgtrees-for-cats');
    ...
    it('should navigate to the correct product page when sku contains "cat"', async () => {
      await router.navigateByUrl('/furniture/cat-tree-skucat-tree_1-ctgtrees-for-cats');

      expect(location.path()).toEqual('/furniture/cat-tree-skucat-tree_1-ctgtrees-for-cats');
    ...
    it('should navigate to the correct product page when sku contains "cat" with simple route', async () => {
      await router.navigateByUrl('/skucat-tree_1-ctgtrees-for-cats');

      expect(location.path()).toEqual('/skucat-tree_1-ctgtrees-for-cats');
