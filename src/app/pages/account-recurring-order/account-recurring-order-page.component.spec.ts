...
describe('Account Recurring Order Page Component', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      imports: [
        ...
        RouterModule.forRoot([{ path: 'account/requisitions/buyer:RecurringOrderId', children: [] }]),
  ...
  it('should display deleted message if the recurring order was deleted', () => {
    when(accountFacade.selectedRecurringOrder$).thenReturn(of(undefined));
    fixture.detectChanges();
    expect(element.querySelector('[data-testing-id=delete-message]')).toBeTruthy();
  });
