 ...
 */
@Component({
  selector: 'ish-spa-payment-concardis-directdebit',
  templateUrl: './spa-payment-concardis-directdebit.component.html',
  changeDetection: ChangeDetectionStrategy.Default,
})
// tslint:disable-next-line: rxjs-prefer-angular-takeuntil
export class SpaPaymentConcardisDirectdebitComponent extends SpaPaymentConcardisComponent {
