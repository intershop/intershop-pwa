 ...
 */
@Component({
  selector: 'ish-spa-payment-concardis-creditcard',
  templateUrl: './spa-payment-concardis-creditcard.component.html',
  changeDetection: ChangeDetectionStrategy.Default,
})
// tslint:disable-next-line: rxjs-prefer-angular-takeuntil
export class SpaPaymentConcardisCreditcardComponent extends SpaPaymentConcardisComponent implements OnInit {
