...
@Component({
  selector: 'ish-spa-payment-concardis-creditcard-cvc-detail',
  templateUrl: './spa-payment-concardis-creditcard-cvc-detail.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
// tslint:disable-next-line: rxjs-prefer-angular-takeuntil
export class SpaPaymentConcardisCreditcardCvcDetailComponent extends SpaPaymentConcardisComponent implements OnInit {
