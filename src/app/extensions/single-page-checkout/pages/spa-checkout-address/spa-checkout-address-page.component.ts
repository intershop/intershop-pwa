...
@Component({
  selector: 'ish-spa-checkout-address-page',
  templateUrl: './spa-checkout-address-page.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SpaCheckoutAddressPageComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private spCheckoutFacade: SpCheckoutFacade,
  ...
  /**
   * Validates the basket and jumps to the next checkout step (Shipping and Payment)
  ...
  nextStep() {
    ...
    this.spCheckoutFacade.continue(2);
  }
