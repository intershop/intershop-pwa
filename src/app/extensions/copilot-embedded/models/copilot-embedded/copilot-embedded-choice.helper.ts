import { CopilotEmbeddedChoicePrompt, CopilotEmbeddedToolCall } from './copilot-embedded.model';
...
export function extractChoicePromptFromToolCalls(
  tools: CopilotEmbeddedToolCall[] | undefined
): CopilotEmbeddedChoicePrompt | undefined {
