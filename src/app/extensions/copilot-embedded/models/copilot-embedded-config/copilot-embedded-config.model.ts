/**
 * Configuration for the Copilot Embedded Flowise integration.
 *
 * Unlike the Copilot, the Copilot Embedded does not load a pre-built chat UI (`web.js`).
 ...
 */
export interface CopilotEmbeddedConfig {
